    ...
    <div className="flex-1 space-y-8 p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-gradient-to-r from-[#ffffff08] to-[#121212] backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 ${
                    activeTab === tab.id
                      ? 'bg-gradient-to-r from-[#00ade8] to-[#0099cc] text-white shadow-lg'
        ...
        <div className="lg:col-span-3">
          <div className="bg-gradient-to-r from-[#ffffff08] to-[#121212] backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            {/* General Settings */}
            {activeTab === 'general' && (
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-6 bg-white/5 rounded-xl border border-white/10">
                      <div>
                        ...
                        <p className="text-gray-400">Use dark theme for the application</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-6 bg-white/5 rounded-xl border border-white/10">
                      <div>
                        ...
                        <p className="text-gray-400">Automatically save changes</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                    ...
                    <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                      ...
                      <select className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#00ade8]">
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-6 p-6 bg-white/5 rounded-xl border border-white/10">
                      <div className="w-20 h-20 bg-gradient-to-br from-[#00ade8] to-[#0099cc] rounded-full flex items-center justify-center">
                      ...
                      <div className="flex-1">
                        ...
                        <button className="px-4 py-2 bg-gradient-to-r from-[#00ade8] to-[#0099cc] text-white rounded-lg hover:from-[#0099cc] hover:to-[#0088bb] transition-all">
                          Upload Image
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#00ade8]"
                        />
                      </div>
                      <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                    ...
                    <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#00ade8] resize-none"
                      />
                    </div>
                  </div>
                </div>
                    ...
                    <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                      ...
                      <div className="space-y-4">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#00ade8]"
                        />
                        <button className="px-6 py-3 bg-gradient-to-r from-[#00ade8] to-[#0099cc] text-white rounded-xl hover:from-[#0099cc] hover:to-[#0088bb] transition-all">
                          Update Password
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                      ...
                      <div className="space-y-4">
                        <label className="flex items-center space-x-3">
                          <input type="checkbox" defaultChecked className="w-4 h-4 text-[#00ade8] bg-white/10 border-white/20 rounded focus:ring-[#00ade8]" />
                        ...
                        <label className="flex items-center space-x-3">
                          <input type="checkbox" className="w-4 h-4 text-[#00ade8] bg-white/10 border-white/20 rounded focus:ring-[#00ade8]" />
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                      ...
                      <div className="space-y-4">
                        <button className="w-full px-6 py-3 bg-gradient-to-r from-[#00ade8] to-[#0099cc] text-white rounded-xl hover:from-[#0099cc] hover:to-[#0088bb] transition-all">
                          Export All Data
                        </button>
